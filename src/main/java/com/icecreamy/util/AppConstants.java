...
public interface AppConstants {
    ...
    // Misc Constants
    public static final String STORAGE_ROOT = System.getProperty("user.home") + File.separator + "icecreamy_storage";
    public static final String UPLOAD_FILE_PATH = STORAGE_ROOT + File.separator + "images" + File.separator;
    public static final String DUMMY_PRODUCTS_PATH = STORAGE_ROOT  + File.separator + "products.json";
